...
///////////////////////////////////////////////////////////////////////////////////////////////
//
// RecordWaveFile.snippet
//
// Copyright � 2005-2007 Avaya Inc. All rights reserved.
// Usage of this source is bound to the terms described in SampleCodeLicense.doc
///////////////////////////////////////////////////////////////////////////////////////////////

try
{
    // NOTE: You must have registered for the various response callback in order to
    // get the results. There are code snippets available to show you how to do this.
  
    int Duration;
// TO DO: Set Duration (in milliseconds) to how long you want the file recorded for. -1 assumes infinite
Duration = -1;        
    
    // TO DO: Set ToneTermination to true if you want the wav files terminated when a tone is detected.
    bool ToneTermination = false;

// TO DO: Set RecordingFileName to the name of the file that you want the call recorded to.
string RecordingFileName;
RecordingFileName = "recordedFileName.wav";
    
    // NOTE: We assume currentDevice is the device that you want the wav file played to.
    // InvokeId is the XML message number that was sent to the server
    int InvokeId;
InvokeId = currentDevice.getPhone.getMedia.StartRecording(RecordingFileName, Duration, ToneTermination, null);
}
catch (Exception exc)
{
    // TO DO: Add you exception code here.
    MessageBox.Show("Exception while attempting a StartRecording: " + exc.Message);
}
